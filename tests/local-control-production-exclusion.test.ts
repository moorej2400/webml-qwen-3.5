...
test("public build contains no local control agent or private connection material", async () => {
  ...
  assert.deepEqual(relativeFiles, [
    ...
    "qwen35-disk-backed-tied-embedding.d.ts",
    "qwen35-disk-backed-tied-embedding.js",
    ...
    "qwen35-rolling-layer-weights.js",
    "qwen35-session.d.ts",
    "qwen35-session.js",
    ...
    "qwen35-vision-runtime.d.ts",
    "qwen35-vision-runtime.js",
  ...
  for (const forbidden of [
    ...
    "QWEN_RUNTIME_UPLOAD_PROBE_TRIAL",
    "uploadProbeTrial",
    "before_write",
    "after_write",
    "after_retire",
